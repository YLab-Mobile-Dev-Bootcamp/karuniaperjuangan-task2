          ...
          children: [
            ...
            Autocomplete<String>(
              optionsBuilder: (TextEditingValue value){
                return listKota.where((element) => element.toLowerCase().startsWith(value.text.toLowerCase())).toList();
              },
              ...
              Row(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Radio(value: 'jne', groupValue: _kurirValue, onChanged: (String? value){setState(() {_kurirValue = value??"";});}),
                      Text("JNE")
                    ],),
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Radio(value: 'pos', groupValue: _kurirValue, onChanged: (String? value){setState(() {_kurirValue = value??"";});}),
                      Text("POS Kilat")
                    ],),
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Radio(value: 'tiki', groupValue: _kurirValue, onChanged: (String? value){setState(() {_kurirValue = value??"";});}),
                      Text("Tiki")
                    ],), 
                ],
              ),
              ...
              ElevatedButton(
                ...
                child: Container(padding: EdgeInsets.all(20), child: Text("Cek Ongkir"),))
          ],
        )
      ),
    );
